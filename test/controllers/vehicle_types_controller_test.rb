...
class VehicleTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_type" do
    assert_difference('VehicleType.count') do
      post vehicle_types_url, params: { vehicle_type: { code: @vehicle_type.code, fosyga: @vehicle_type.fosyga, name: @vehicle_type.name, prime: @vehicle_type.prime, runt: @vehicle_type.runt, subtype: @vehicle_type.subtype, tax: @vehicle_type.tax, year: @vehicle_type.year } }
    end
  ...
  test "should update vehicle_type" do
    patch vehicle_type_url(@vehicle_type), params: { vehicle_type: { code: @vehicle_type.code, fosyga: @vehicle_type.fosyga, name: @vehicle_type.name, prime: @vehicle_type.prime, runt: @vehicle_type.runt, subtype: @vehicle_type.subtype, tax: @vehicle_type.tax, year: @vehicle_type.year } }
